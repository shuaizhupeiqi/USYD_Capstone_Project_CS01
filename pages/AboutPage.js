        ...
        <Layout>
          {this.state.loading ? (
            ...
            <div>
              ...
              <Card bordered={false} style={{ textAlign: 'center',    borderRadius: 0 ,width: '116%', marginLeft: '-8%', marginRight: '-8%' , backgroundColor:   "#5A5A5A"}}>
              <Title style={{ fontSize: "300%", fontWeight: 'bold',color:"white",  }}>
              About Heat Stress Scale (HSS)
